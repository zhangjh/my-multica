...
// ETXTBSY ("text file busy"); openclawActiveConfigPath then falls back to
// `config file` and the test fails on the wrong answer (Go #22315). Windows has
// no such race; holding the lock there is harmless.
